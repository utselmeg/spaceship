...
def group_collide(group, other_object):
    for sprite in set(group):
        if sprite.collide(other_object):
            ...
            explode = Sprite(sprite.get_position(), [0,0],0, 0, explosion_image, explosion_info, explosion_sound) 
...
def rock_spawner():
    global a_rock, rock_group, score, lives
    ...
    if len(rock_group) < 10:
        ...
        pass
    if dist(rock_pos, my_ship.get_position()) <= 70:
        lives += 1
